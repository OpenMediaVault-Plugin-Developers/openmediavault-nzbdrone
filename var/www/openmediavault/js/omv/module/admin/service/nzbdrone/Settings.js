...
Ext.define("OMV.module.admin.service.nzbdrone.Settings", {
    ...
    getFormItems : function() {
        ...
        return [{
            ...
            items : [{
                ...
                boxLabel   : _("Show tab containing NzbDrone web interface frame."),
                checked    : false
            },{
                xtype: "numberfield",
                name: "port",
...
OMV.WorkspaceManager.registerPanel({
    id        : "settings",
    path      : "/service/nzbdrone",
    text      : _("Settings"),
    position  : 10,
    className : "OMV.module.admin.service.nzbdrone.Settings"
});
